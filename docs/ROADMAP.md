...
- **Task 006: 더미 데이터 및 목업 유틸리티 작성** - 우선순위
...
1. **Task 006**: 더미 데이터 및 목업 유틸리티 작성 - 모든 UI 작업의 기반
2. **Task 007**: 견적서 목록 페이지 UI 구현
3. **Task 008**: 견적서 상세 페이지 UI 구현
